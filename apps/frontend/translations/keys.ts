...
const langKeys = (): TLangKeys => {
  ...
  const keys: TLangKeys = {
    ...
    AlertSignUpInvitationSentTitle: ('ALERT_SIGN_UP_INVITATION_SENT_TITLE'),
    ErrorAccountAlreadyExists: ('ERROR_ACCOUNT_ALREADY_EXISTS'),
    ErrorAccountInvalidCredentials: ('ERROR_ACCOUNT_INVALID_CREDENTIALS'),
    ErrorAccountNotExists: ('ERROR_ACCOUNT_NOT_EXISTS'),
